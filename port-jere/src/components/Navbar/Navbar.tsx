...
console.log(pathName)
    return (
        ...
        >
            <div className="flex items-center justify-between w-full px-4 py-3 md:py-8 md:flex-col md:justify-center gap-y-10 md:px-4 md:h-max bg-black/60 backdrop-blur-sm md:rounded-full">
