                ...
                <div className="container justify-between mx-auto md:flex">
                    <div className="flex w-full items-center justify-center gap-7">
                        <div className="flex justify-center items-center ">
                            <Link href="/">
                                <img className="sm:h-20 sm:md-32 h-12 w-20  lg:w-32 md:w-32 md:h-20 animate-pulse" src="/J-logos_black.png" alt="Logo" />
                            </Link>
                        </div>
                        <div className="container justify-center items-center flex">
                            <h1 className="font-extrabold text-3xl text-center">Bien</h1>
                            <span className="text-3xl text-center font-extrabold text-blue-400">Venido</span>
                        </div>
